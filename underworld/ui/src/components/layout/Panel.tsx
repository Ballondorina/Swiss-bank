// ============================================================
// UNDERWORLD — Main Panel Container
// ============================================================
...
export function Panel() {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 animate-fade-in">
      ...
      {/* Panel */}
      <div className="relative w-[900px] max-w-[95vw] h-[600px] max-h-[90vh] bg-surface-1 border border-white/8 rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-slide-up">
        <Header />
        <Nav />
