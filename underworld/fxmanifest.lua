...
name 'underworld'
description 'Underworld — Organization System v3'
version '3.0.0'
author 'Custom'
...
server_scripts {
    ...
    'server/wars.lua',      -- war declarations + alliances + diplomacy
    'server/votes.lua',     -- democratic voting system
    ...
    'server/drugs.lua',     -- drug lab production + delivery pipeline
    'server/robbery.lua',   -- store robbery system
...
client_scripts {
    ...
    'client/drugs.lua',     -- drug lab targets + store robbery targets + delivery HUD
}
